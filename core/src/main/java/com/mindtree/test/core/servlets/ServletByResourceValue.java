...
@SlingServletResourceTypes(methods = { HttpConstants.METHOD_GET,
		HttpConstants.METHOD_POST }, resourceTypes = "TestAEM/components/structure/page", selectors = { "shree",
				"ms" }, extensions = { "txt", "xml" })
public class ServletByResourceValue extends SlingAllMethodsServlet {

	private static final Logger LOG = LoggerFactory.getLogger(ServletByResourceValue.class);
